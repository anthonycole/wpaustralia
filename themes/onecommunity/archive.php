...
<div class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="Fixed link <?php the_title_attribute(); ?>"><?php the_title(); ?></a>
	...
	<div class="blog-bottom">
		...
		<div class="blog-bottom-tags <?php if ( has_tag() ) { echo "blog-bottom-tags-has"; } else { echo "blog-bottom-tags-empty"; } ?>"><?php the_tags('', ', ', '  '); ?></div><div class="blog-bottom-spacer blog-bottom-spacer-tags <?php if ( has_tag() ) { echo "blog-bottom-spacer-tags-has"; } else { echo "blog-bottom-spacer-tags-empty"; } ?>"></div>
