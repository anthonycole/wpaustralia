...
function add_scripts(){
  if (!is_admin()) {
   ...
   wp_enqueue_script('QuicksandBold',get_stylesheet_directory_uri().'/js/QuicksandBold.font.js',false,'1.0',false);
   wp_enqueue_script('OneByOneMin',get_stylesheet_directory_uri().'/slider/jquery.onebyone.min.js',false,'1.0',false);
   wp_enqueue_script('Touchwipe',get_stylesheet_directory_uri().'/slider/jquery.touchwipe.min.js',false,'1.0',false);
...
function my_bp_core_set_avatar_constants() {
	...
	if ( !defined( 'BP_AVATAR_ORIGINAL_MAX_WIDTH' ) )
		define( 'BP_AVATAR_ORIGINAL_MAX_WIDTH', 185 );
